...
const translations = {
  en: {
    currentPricesStatus: 'Prices are currently {status}', priceIsStatus: '€{price} is {status}', priceStatusLow: 'low', priceStatusAverage: 'average', priceStatusHigh: 'high', currentStatusLow: 'low', currentStatusAverage: 'average', currentStatusHigh: 'high', loginToTrack: 'Log in with Google to track this flight.', targetPriceInvalid: 'Enter a target price greater than zero.',
    welcomeTuniFly: 'Welcome, {name}, to TuniFly!', welcomeTuniFlyGuest: 'Welcome to TuniFly!', signInToSaveAlerts: 'Sign in to save price alerts and receive notifications.', logInWithGoogle: 'Log in with Google', logOut: 'Log out', next7Days: 'Next 7 days', restOfMonth: 'Rest of {month}', next3Months: 'Next 3 months',
    appDescription: 'Flight search and price tracking for travelers flying to and from Tunisia.', googleSignInPurpose: 'Sign in with Google to save your flight-alert preferences.', privacyPolicy: 'Privacy Policy', contactUs: 'Contact Us', footerNavigation: 'Footer navigation', footerCopyright: '\u00a9 {year} TuniFly. All rights reserved.', supportRequestSubject: 'TuniFly Support Request',
    trackedFlights: 'Tracked Flights:', noTrackedFlights: 'You have no tracked flights.', enableNotifications: 'Enable email notifications',
  ...
  ar: {
    signInToSaveAlerts: '\u0633\u062c\u0651\u0644 \u0627\u0644\u062f\u062e\u0648\u0644 \u0644\u062d\u0641\u0638 \u062a\u0646\u0628\u064a\u0647\u0627\u062a \u0627\u0644\u0623\u0633\u0639\u0627\u0631 \u0648\u062a\u0644\u0642\u064a \u0627\u0644\u0625\u0634\u0639\u0627\u0631\u0627\u062a.',
    logInWithGoogle: '\u0633\u062c\u0651\u0644 \u0627\u0644\u062f\u062e\u0648\u0644 \u0628\u0627\u0633\u062a\u062e\u062f\u0627\u0645 Google',
    logOut: '\u062a\u0633\u062c\u064a\u0644 \u0627\u0644\u062e\u0631\u0648\u062c',
    currentPricesStatus: '\u0627\u0644\u0623\u0633\u0639\u0627\u0631 \u062d\u0627\u0644\u064a\u064b\u0627 {status}', priceIsStatus: '\u0633\u0639\u0631 €{price} {status}', priceStatusLow: '\u0645\u0646\u062e\u0641\u0636', priceStatusAverage: '\u0645\u062a\u0648\u0633\u0637', priceStatusHigh: '\u0645\u0631\u062a\u0641\u0639', currentStatusLow: '\u0645\u0646\u062e\u0641\u0636\u0629', currentStatusAverage: '\u0645\u062a\u0648\u0633\u0637\u0629', currentStatusHigh: '\u0645\u0631\u062a\u0641\u0639\u0629', loginToTrack: '\u0633\u062c\u0651\u0644 \u0627\u0644\u062f\u062e\u0648\u0644 \u0628\u0627\u0633\u062a\u062e\u062f\u0627\u0645 Google \u0644\u062a\u062a\u0628\u0639 \u0647\u0630\u0647 \u0627\u0644\u0631\u062d\u0644\u0629.', targetPriceInvalid: '\u0623\u062f\u062e\u0644 \u0633\u0639\u0631\u064b\u0627 \u0645\u0633\u062a\u0647\u062f\u0641\u064b\u0627 \u0623\u0643\u0628\u0631 \u0645\u0646 \u0627\u0644\u0635\u0641\u0631.',
    welcomeTuniFly: '\u0645\u0631\u062d\u0628\u064b\u0627 \u0628\u0643\u060c {name}\u060c \u0641\u064a TuniFly!', welcomeTuniFlyGuest: '\u0645\u0631\u062d\u0628\u064b\u0627 \u0628\u0643 \u0641\u064a TuniFly!', next7Days: '\u0627\u0644\u0623\u064a\u0627\u0645 \u0627\u0644\u0633\u0628\u0639\u0629 \u0627\u0644\u0642\u0627\u062f\u0645\u0629', restOfMonth: '\u0628\u0642\u064a\u0629 \u0634\u0647\u0631 {month}', next3Months: '\u0627\u0644\u0623\u0634\u0647\u0631 \u0627\u0644\u062b\u0644\u0627\u062b\u0629 \u0627\u0644\u0642\u0627\u062f\u0645\u0629',
    trackedFlights: '\u0627\u0644\u0631\u062d\u0644\u0627\u062a \u0627\u0644\u0645\u062a\u062a\u0628\u0639\u0629:', noTrackedFlights: '\u0644\u064a\u0633 \u0644\u062f\u064a\u0643 \u0623\u064a \u0631\u062d\u0644\u0627\u062a \u0645\u062a\u062a\u0628\u0639\u0629 \u062d\u0627\u0644\u064a\u064b\u0627.', enableNotifications: '\u062a\u0641\u0639\u064a\u0644 \u0625\u0634\u0639\u0627\u0631\u0627\u062a \u0627\u0644\u0628\u0631\u064a\u062f \u0627\u0644\u0625\u0644\u0643\u062a\u0631\u0648\u0646\u064a',
    appDescription: '\u0627\u0644\u0628\u062d\u062b \u0639\u0646 \u0627\u0644\u0631\u062d\u0644\u0627\u062a \u0648\u062a\u062a\u0628\u0639 \u0623\u0633\u0639\u0627\u0631\u0647\u0627 \u0644\u0644\u0645\u0633\u0627\u0641\u0631\u064a\u0646 \u0645\u0646 \u062a\u0648\u0646\u0633 \u0648\u0625\u0644\u064a\u0647\u0627.', googleSignInPurpose: '\u0633\u062c\u0651\u0644 \u0627\u0644\u062f\u062e\u0648\u0644 \u0628\u0627\u0633\u062a\u062e\u062f\u0627\u0645 Google \u0644\u062d\u0641\u0638 \u062a\u0641\u0636\u064a\u0644\u0627\u062a \u062a\u0646\u0628\u064a\u0647\u0627\u062a \u0627\u0644\u0631\u062d\u0644\u0627\u062a.', privacyPolicy: '\u0633\u064a\u0627\u0633\u0629 \u0627\u0644\u062e\u0635\u0648\u0635\u064a\u0629', contactUs: '\u0627\u062a\u0635\u0644 \u0628\u0646\u0627', footerNavigation: '\u062a\u0646\u0642\u0644 \u062a\u0630\u064a\u064a\u0644 \u0627\u0644\u0635\u0641\u062d\u0629', footerCopyright: '\u00a9 {year} TuniFly. \u062c\u0645\u064a\u0639 \u0627\u0644\u062d\u0642\u0648\u0642 \u0645\u062d\u0641\u0648\u0638\u0629.', supportRequestSubject: '\u0637\u0644\u0628 \u062f\u0639\u0645 TuniFly',
    ...
    closeDetails: 'إغلاق تفاصيل الرحلة', history: 'تاريخ الأسعار لهذا البحث', loadingChart: 'جارٍ تحميل الرسم...', pricesCurrently: 'الأسعار حاليًا', similarTrips: 'تكلفة الرحلات المشابهة عادةً بين €{low}–€{high}.', trackFlight: 'تتبع هذه الرحلة', targetPrice: 'السعر المستهدف', currentAlert: 'التنبيه الحالي: €{price}', saving: 'جارٍ الحفظ...', updateAlert: 'تحديث التنبيه', setAlert: 'تعيين تنبيه', emailFirst: 'أدخل بريدك الإلكتروني أولاً لتتبع هذه الرحلة.', alreadyTracking: 'أنت تتتبع هذه الرحلة بالفعل. حدّث السعر المستهدف عند الحاجة.', readyToBook: 'جاهز للحجز؟', bookNow: 'احجز الآن ✈️', min: 'الحد الأدنى', max: 'الحد الأقصى',
  },
  de: {
    signInToSaveAlerts: 'Melden Sie sich an, um Preisalarme zu speichern und Benachrichtigungen zu erhalten.',
    logInWithGoogle: 'Mit Google anmelden',
    logOut: 'Abmelden',
    appDescription: 'Flugsuche und Preisverfolgung f\u00fcr Reisende von und nach Tunesien.', googleSignInPurpose: 'Melden Sie sich mit Google an, um Ihre Flugalarm-Einstellungen zu speichern.', privacyPolicy: 'Datenschutz', contactUs: 'Kontakt', footerNavigation: 'Fu\u00dfzeilennavigation', footerCopyright: '\u00a9 {year} TuniFly. Alle Rechte vorbehalten.', supportRequestSubject: 'TuniFly-Supportanfrage',
    currentPricesStatus: 'Die Preise sind derzeit {status}', priceIsStatus: '€{price} ist {status}', priceStatusLow: 'niedrig', priceStatusAverage: 'durchschnittlich', priceStatusHigh: 'hoch', currentStatusLow: 'niedrig', currentStatusAverage: 'durchschnittlich', currentStatusHigh: 'hoch', loginToTrack: 'Melden Sie sich mit Google an, um diesen Flug zu verfolgen.', targetPriceInvalid: 'Geben Sie einen Zielpreis größer als null ein.',
    welcomeTuniFly: 'Willkommen, {name}, bei TuniFly!', welcomeTuniFlyGuest: 'Willkommen bei TuniFly!', next7Days: 'Nächste 7 Tage', restOfMonth: 'Restlicher {month}', next3Months: 'Nächste 3 Monate',
    trackedFlights: 'Verfolgte Flüge:', noTrackedFlights: 'Sie haben keine verfolgten Flüge.', enableNotifications: 'E-Mail-Benachrichtigungen aktivieren',
