...
const translations = {
  en: {
    ...
    welcomeTuniFly: 'Welcome, {name}, to TuniFly!', welcomeTuniFlyGuest: 'Welcome to TuniFly!', next7Days: 'Next 7 days', restOfMonth: 'Rest of {month}', next3Months: 'Next 3 months',
